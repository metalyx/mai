<br />
<div class="container">
<form method="post" action="<?php echo base_url();?>workdb/add_student">
  ...
  <div class="form-group">
    ...
    <input name="id_group" class="form-control">
    <small class="form-text text-muted">Посмотреть id всех групп можно во вкладке "Группы"</small>
  </div>
  <div class="form-group">
